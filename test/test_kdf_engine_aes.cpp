...
TEST(TestKdfEngineAes, Transform) {
    ...
    ByteVector expected_one_round = {
        0x33, 0x87, 0x94, 0xfb, 0x98, 0xa1, 0x4d, 0xbe,
        0xa0, 0x4d, 0xad, 0x14, 0xf3, 0xab, 0x03, 0xe5,
        0x65, 0x4e, 0x86, 0xb5, 0xb5, 0x2d, 0xe3, 0x5d,
        0x88, 0x6c, 0x2a, 0xca, 0xd2, 0x3e, 0xa1, 0x9a
    };
    EXPECT_EQ(result, expected_one_round);

    params[KdfEngineAes::paramRounds] = std::uint64_t(6000);
    result = aes.transform(message, params);
    ByteVector expected_several_rounds = {
        0xe3, 0xa8, 0x90, 0x77, 0x8b, 0xbc, 0xb1, 0x13,
        0x0b, 0x93, 0xb2, 0xf3, 0xbe, 0x9f, 0xcd, 0x2a,
        0x9a, 0x56, 0xb6, 0x6a, 0xaf, 0x22, 0x14, 0x56,
        0xa6, 0xd2, 0xcb, 0x55, 0x44, 0x88, 0xca, 0x99
    };
    EXPECT_EQ(result, expected_several_rounds);
}
